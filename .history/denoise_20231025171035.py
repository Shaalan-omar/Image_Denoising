...
output_folder = '/Users/omarshaalan/Documents/AUC/Fall2023/Thesis/Denoising_Images/Output'  # Replace with the path to the folder where you want to save the processed images
